...
namespace Rosanna.Tests
{
    public class FeedBuilderTests
    {
        ...
        public void Entry_contains_data_from_article()
        {
            ...
            item.Id.ShouldEqual("http://example.com/2010/08/05/new-blog-in-five-minutes");
            item.Title.Text.ShouldEqual("New blog in five minutes");
            item.Links[0].Uri.OriginalString.ShouldEqual("http://example.com/2010/08/05/new-blog-in-five-minutes");
